...
declare -gA ERROR_MESSAGES=(
  ...
  [PORT_80_IN_USE]="Port 80 is in use by: %s (ACME HTTP-01 challenge requires port 80)"
  [PORT_80_BLOCKED]="Port 80 appears to be blocked or unavailable for ACME HTTP-01 challenge"

  # Cloudflare API errors
  [CF_API_TOKEN_MISSING]="CF_API_TOKEN is required for DNS-01 challenge (CERT_MODE=cf_dns)"
  [CF_API_TOKEN_INVALID]="Invalid CF_API_TOKEN format: must be %s-%s alphanumeric characters"
  [CF_DNS_CHALLENGE_FAILED]="DNS-01 certificate challenge failed: %s"
